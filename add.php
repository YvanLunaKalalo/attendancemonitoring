...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (mysqli_query($conn, $sql)) {
        echo "<script>alert('New record created successfully!'); window.location.href = 'attendance.php';</script>";
    ...
    <div class="container">
        ...
        <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
            ...
            <div class="form-group">
                ...
                <input type="tel" class="form-control" name="phone_num" value="<?php echo $phone_num; ?>" required maxlength="11">
            </div>
            ...
            <a href="attendance.php" class="btn btn-outline-danger mt-3">Cancel</a>
            <a href="home.php" class="btn btn-outline-primary mt-3 float-end">Back to Home</a>
